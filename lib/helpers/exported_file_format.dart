...
class ExportedFileFormatHelper {
  static final defaultFormat = "call_logger-%y%m%d-%H%M%S";
  
  static final Map<String, String> _strfToDateFormat = { // source: https://chatgpt.com
    ...
    "W": "W",         // Week number of the year (00-53), Monday as the first day of the week
    "c": "EEE, MMM d yyyy HH:mm:ss", // Date and time representation (e.g., Fri, Jul 12 2024 14:15:00)
      ...
      if (char == "%") {
        ...
        if (ctrlChar == "%") { // %% -> %
          ...
          if (_strfToDateFormat.containsKey(ctrlChar)) {
            timeFormatItems.add(TimeFormatItem(_strfToDateFormat[ctrlChar]!, true));
          } else { // invalid strftime char found
            return null;
          }
        }
        i++;
