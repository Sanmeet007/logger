...
Iterable<CallLogEntry> getFilteredLogs(Map params) {
  var logs = params["logs"] ?? const Iterable.empty() as Iterable<CallLogEntry>;
    ...
    case "Past Month":
      logs = logs?.where((e) {
        ...
        return (shouldUseSpecificPhoneNumber
            ...
            callTypes.contains(e.callType) &&
            entryDate.isAfter(
                firstDayOfPreviousMonth.subtract(const Duration(seconds: 1))) &&
